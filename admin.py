...
class CRUDEventAdmin(admin.ModelAdmin):
    list_display = ['get_event_type_display', 'content_type', 'object_repr', 'object_json_repr', 'user', 'datetime']
    list_filter = ['content_type', 'object_id', 'object_repr', 'user', 'datetime']
